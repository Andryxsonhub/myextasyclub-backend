...
// Buscar perfil público de outro usuário (GET /api/users/profile/:id) (Gratuito pode)
...
// ROTA DELETAR VÍDEO (Pode ser 'checkAuth' - só quem postou pode deletar, e quem postou era pago)
...
// ==========================================
// NOVAS ROTAS PARA LISTAS DE ESTATÍSTICAS (Gratuito pode)
// ==========================================
