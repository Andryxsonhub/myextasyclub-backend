// myextasyclub-backend/routes/userRoutes.js (VERSÃO CORRIGIDA E COM DEBUG)
...
  try {
    // --- DEBUG 1: VERIFICANDO FILTROS RECEBIDOS ---
    // Este console.log vai nos mostrar exatamente o que o frontend está enviando.
    console.log("===================================");
...
    }
    ...
    // --- MUDANÇA 1: REMOVIDO BLOCO PROBLEMÁTICO ---
    // O if-statement abaixo retornava um array vazio se nenhum filtro fosse aplicado,
    // o que causava a falha inicial na página Explorar. Agora, sem ele,
    // a busca sem filtros retornará todos os usuários.
    /*
 ...
     }
    */
    ...
    // --- DEBUG 2: VERIFICANDO CONSULTA DO PRISMA ---
    // Este console.log vai nos mostrar o objeto exato que está sendo usado para
