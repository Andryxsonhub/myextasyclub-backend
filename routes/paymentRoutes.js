...
// --- ATUALIZAÇÃO FINAL (Hardcode do Payer Name + LIMPEZA DE ARTEFATOS) ---
...
// ===============================================================
// ROTA PARA CRIAR PAGAMENTO DE PIMENTAS (COM CORREÇÃO NO PAYER)
// ===============================================================
  ...
  try {
    ...
    const preferenceData = {
      body: {
        ...
        payer: {
          name: payerName, // <-- Usa a variável corrigida
          email: user.email,
        },
        back_urls: {
...
router.post('/webhook-mercadopago', async (req, res) => {
  ...
  try {
    ...
    // --- ★★★ ARTEFATO 'section' REMOVIDO DAQUI ★★★ ---
  res.sendStatus(200);
  } catch (error) {
